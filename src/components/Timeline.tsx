...
const Timeline = () => {
  return (
    <>
      <div
        id="timeline"
        className="flex flex-col items-center justify-center gap-8 bg-[#023a89] p-4 pb-24 pt-24"
      >
        <h1 className="text-5xl font-bold tracking-[0.1em] font-newsweekly">TIMELINE</h1>
