        ...
        <>
            <div className="navbar relative z-20 flex items-center justify-between px-2 lg:px-32">
                ...
                <ul className="menu menu-horizontal hidden gap-12 lg:flex">
                    <li>
                        <label className="rounded-lg" htmlFor="modal-peraturan">Peraturan</label>
                    </li>
                    <li>
                        <a className="rounded-lg" onClick={() => document.getElementById('kandidat')?.scrollIntoView({ behavior: 'smooth' })}>
                            Kandidat
                        </a>
                    </li>
                    <li>
                        <a className="rounded-lg" onClick={() => document.getElementById('timeline')?.scrollIntoView({ behavior: 'smooth' })}>
                            Timeline
                        </a>
                    </li>
                </ul>
