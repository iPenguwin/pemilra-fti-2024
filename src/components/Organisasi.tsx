...
const Organisasi = () => {
    return (
        <>
            <div id="kandidat" className="flex flex-col items-center justify-center gap-8 bg-[#022960] p-4 py-24">
                <h1 className="text-5xl font-bold tracking-[0.1em] font-newsweekly">ORGANISASI</h1>
