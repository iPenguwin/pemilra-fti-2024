...
const Organisasi = () => {
  return (
    <>
      <div
        id="kandidat"
        className="flex flex-col items-center justify-center gap-8 bg-[#022960] p-4 py-24"
      >
        <h1 className="font-newsweekly text-5xl font-bold tracking-[0.1em]">ORGANISASI</h1>
                ...
                <div className="flex flex-col justify-center gap-4 overflow-auto lg:flex-row">
                  {item.kandidat.map((k) => {
                    return (
                      ...
                      >
                        <img
                          className="aspect-square h-64 w-64 rounded-2xl bg-primary bg-center p-2"
                          src={k.foto}
                          alt={k.name}
                        />
            ...
            >
              <div className="z-60 modal-box max-w-full">
                <div className="card card-side flex flex-col items-center justify-center gap-4 bg-base-200 p-8 shadow-xl">
                  ...
                  <img
                    className="aspect-square h-64 w-64 rounded-3xl bg-primary bg-cover bg-center p-2"
                    src={k.foto}
                    alt={k.name}
                  />
